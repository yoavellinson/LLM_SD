...
# Config
# -------------------------------------------------------------
SAVE_DIR = Path("/home/workspace/yoavellinson/LLM_SD/diarization_logs_hybrid")
...
module = SpeakerExtractionModule.load_from_checkpoint(MODEL_CKPT, map_location="cuda")
module.eval()
